...
function ProductList() {
    ...
    // Handle adding a product to the cart and updating the addedToCart state
    ...
    // Sample plant categories and products
    const plantsArray = [
        {
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={handleCartClick} style={styleA}>
                            ...
                            <span>Total Items: {calculateTotalQuantity()}</span>
                        </a>
                    </div>
                </div>
            </div>
